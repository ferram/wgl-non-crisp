...
whenever proof search fails. As a consequence, we established that 
 ...
 Notably, when proof search fails, the computation can be traced to construct a finite countermodel for the given formula.
 This  proves the finite model property for  $\GWL$. 
