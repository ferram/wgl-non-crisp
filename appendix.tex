...
The proof of~\ref{lemma:defBD:2} is similar. \qed
...
Properties~\ref{defBD:P1} and~\ref{defBD:P2} holds.
  ...
  \begin{proof}
    ...
    in the \GCM-model $\M^\ast$ in  Fig.~\ref{fig:ind} we have
...
This proves that~\ref{defBD:P1} holds. The proof of~\ref{defBD:P2} is similar.  \qed
  \end{proof}
...
\begin{figure}[h]
  ...
  \begin{minipage}{0.5\linewidth}
    ...
    \]
  \end{minipage}
  \caption{The \GCM-model  $\M^\ast=\stru{W,R,e}$.}
  \label{fig:ind}
\end{figure}
