...
let $p \in \PV$,  $r\in[0,1]$ and   $w^\star\in W$.
The evaluation function   $\reass{e}{p}{r}$   and the  $\M$-interpretation  $\reass{\Ical}{w}{w^\star}$ are defined as follows:
\[
\reass{e}{p}{r}(w,p')\:=\;
  \begin{cases}
  r &\text{if $p'=p$}  
...
\hspace{4em}
 ...
 \Ical(w') &\text{otherwise}   
  \end{cases}
\]
One can prove that  $\M=\stru{W,R, \reass{e}{p}{r}}$ is a \GWM-model.
...
$e(\Ical(w),\b) < \Ical(t)$.
Let $r=e(\Ical(w),\b)$ and  $\M'=\stru{W,R,\reass{e}{q}{r}}$;
...
\qquad
  ...
  $\M\models_\Ical 1 \gt t$.  Let
  $r=e(\Ical(w),\a)$ and $\M'=\stru{W,R,\reass{e}{q}{r}}$;  note that  $\M'$ is a  \GWM-model. 
