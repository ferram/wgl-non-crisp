...
Let $\chi= w:\Box\a\gt t$ and  $w'\in W$;
we show that:
...
By definition of $\M$, the value of $R(w,w')$ is 0, thus
...
\begin{itemize}
\item $\app{\chi'}{\G_{k-1}}{\G_k}$, where $\chi' = w :\Box \varphi \lt t'$ or  $\chi' = w :\Diam\varphi \gt t'$,
  and the new label inotroduced by $\rho$ is  $w'$.
\end{itemize}
