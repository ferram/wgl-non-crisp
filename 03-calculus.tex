...
Hereafter, in constraints $\lt$ and $\lt'$ are metasymbols ranging in
...
\begin{figure}[t]
  ...
  \begin{tabular}{p{\linewidth}}
    ...
    \infer[\to<]{
      ...
      \infer[\ruleToLEQAt]{
        w_0: \Box p > c,\;
        \underline{w_0: \neg  \Diamond  \neg p \leq c},\;   c < 1\mbox{$_{(1)}$}}{
        \infer[\textrm{Ax}]{
          \Delta_0\mbox{$_{(2)}$}}{
        }
        &
        \infer[\Diamond\gt]{
          w_0: \Box p > c,\;\underline{w_0: \Diamond  \neg p > w_0:\bot},\;\Delta_1\mbox{$_{(3)}$}}{
          \infer[R\land \gt]{
            w_0: \Box p > c,\; R(w_{0} ,w_{1})\to w_1:p > c,\; 
            \underline{R(w_{0} ,w_{1})\land w_1: \neg p > w_0:\bot},\;\Delta_1\mbox{$_{(4)}$}}{
            \infer[\ruleToGAt]{
              R(w_{0} ,w_{1})\to w_1:p > c,\;
              \underline{w_1: \neg p > w_0:\bot},\; \Delta_2\mbox{$_{(5)}$}}{
              % \Dcal_1\hspace{15ex}
              \infer[R\to \gt]{
                \underline{R(w_{0} ,w_{1})\to w_1:p > c},\;\Delta_3\mbox{$_{(6)}$}}{
                \infer[\textrm{Ax}]{
                  w_1:p \geq R(w_{0} ,w_{1}),\;  1 > c,\;\D_3\mbox{$_{(7)}$}}{
                }
                &
                \infer[\textrm{Ax}]{
                  w_1:p > c,\;\D_3\mbox{$_{(8)}$}}{
                }
              }
              &
              % \hspace{15ex}\Dcal_2
              \infer[\textrm{Ax}]{\Delta_4 \mbox{$_{(9)}$}  }{}
            }
          }
        }
      }
    ...
    %     \[
    %     \infer[R\to \gt]{
    %     \underline{R(w_{0} ,w_{1})\to w_1:p > c},\;\Delta_4\mbox{$_{(9)}$}}{
    %     \infer[\textrm{Ax}]{
    %     \Delta_4, w_1:p \geq R(w_{0} ,w_{1}), 1 > c,\mbox{$_{(10)}$}}{
    %   }
    %     &
    %     \infer[\textrm{Ax}]{
    %     \Delta_4, w_1:p > cX\mbox{$_{(11)}$}}{
    %   }
    %   } %%
    %     \]
    %   \end{minipage}\right.$
