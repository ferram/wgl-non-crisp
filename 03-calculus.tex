...
\begin{proof}
  Since the modal logic $\KL$ is PSPACE-complete~\cite{Ladner:77} and $\KL$ can be embedded into $\GWL$
  (see Prop.~\ref{prop:embedding}),   the validity problem for $\GWL$   is PSPACE-hard.
