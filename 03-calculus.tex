...
An example of derivation is shown in Fig.~\ref{fig:der}.  In
representing derivations, we underline the main constraint of a rule
...
\begin{figure}[t]
  \centering\small
  \begin{tabular}{p{100ex}}
  \[
  \begin{array}{lcl}
    \Delta_0&=& w_0:q_{0} < 1, w_0:q_{0} \geq 1, w_0: \Box a > w_0:q_{0}\\
    \Delta_1&=&  w_0:q_{0} < 1, w_0:\bot \leq w_0:q_{0}\\
    \Delta_2&=& \Delta_1, R(w_{0} ,w_{1}) > w_0:\bot, w_0: \Box a > w_0:q_{0}, w_1:a \leq w_1:\bot\\
    \Delta_3&=& \Delta_1, R(w_{0} ,w_{1}) > w_0:\bot, w_0: \Box a > w_0:q_{0}, w_1:\bot > w_0:\bot\\
  \end{array}
  \]
  \\
  $\Dcal=\left\{
    \begin{minipage}{100ex}\small
      $
      \infer[\to<]{
        \underline{w_0: \Box a \to  \neg  \Diamond  \neg a  < 1}\mbox{$_{(0)}$}}{
        \infer[\to\leq]{
          w_0:q_{0} < 1, w_0: \Box a > w_0:q_{0}, 
  ...
  $\Dcal_1=\left\{
    \begin{minipage}{80ex}\small
      \[
      \infer[R\to \gt]{
        \Delta_2, 1 > w_0:\bot,  \underline{R(w_{0} ,w_{1})\to w_1:a > w_0:q_{0}}\mbox{$_{(6)}$}}{
        \infer[\textrm{Ax}]{
          \Delta_2, 1 > w_0:\bot, w_1:a \geq R(w_{0} ,w_{1}), 1 > w_0:q_{0}\mbox{$_{(7)}$}}{
        }
        &
        \infer[\textrm{Ax}]{
          \Delta_2, 1 > w_0:\bot, w_1:a > w_0:q_{0}\mbox{$_{(8)}$}}{
        }
      }
      \]
    \end{minipage}
  ...
  $\Dcal_2=\left\{
    \begin{minipage}{80ex}\small
      \[
      \infer[R\to \gt]{
        \Delta_3, \underline{R(w_{0} ,w_{1})\to w_1:a > w_0:q_{0}}\mbox{$_{(9)}$}}{
        \infer[\textrm{Ax}]{
          \Delta_3, w_1:a \geq R(w_{0} ,w_{1}), 1 > w_0:q_{0},\mbox{$_{(10)}$}}{
        }
        &
        \infer[\textrm{Ax}]{
          \Delta_3, w_1:a > w_0:q_{0}\mbox{$_{(11)}$}}{
        }
      } %%
      \]
    \end{minipage}\right.$
\end{tabular}
\caption{The derivation $\Dcal$ of $w_0: \Box a \to  \neg  \Diamond  \neg a  < 1$.}
\label{fig:der}
\end{figure}
...
To prove strong termination of $\Calcw$, we define the relation $\precc$ between multisets of constraints. 
To this aim, we introduce a weight function $\wgname$ on constraints $u$  and multisets of constraints $\G$,
together with the multisets  $\G[w]$ (multiset of constraints) and $\sizem{\G}$ (multiset of natural numbers). 
...
%By Prop.~\ref{prop:compl}, $\GWL$ has the finite model property.
