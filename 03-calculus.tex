...
$e(\Ical(w),\b) < \Ical(t)$.
Let $r=e(\Ical(w),\b)$, let $e'=e[(\Ical(w),q):=r]$   and   $\M'=\stru{W,R,e'}$;
we remark  that $\M'$ is a \GWM-model.
  ...
  Let $r=e(\Ical(w),\b)$,  let  $e'=e[(\Ical(w),q):=r]$ and
  $\M'=\stru{W,R,e'}$; note that $\M'$ is a $\GWM$-model.  Since
...
\qquad
  ...
  $r=e(\Ical(w),\a)$, let  $e'=e[(\Ical(w),q):=r]$ and  $\M'=\stru{W,R,e'}$;
  note that  $\M'=\stru{W,R,e'}$ is a  \GWM-model. 
