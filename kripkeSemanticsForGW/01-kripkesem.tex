...
introduced in~\cite{VidalR:26}.
  We exploit Prop.~\ref{prop:equivGWC} to show that $\varphi\in\GWL$.
Let us assume, by contradiction,   $\varphi\not\in\GWL$.
By  Prop.~\ref{prop:equivGWC}, there exists a regular  $\GWM$-bimodel $\K=\stru{X,\leq,S,V}$
...
\begin{itemize}
\item if $x S y$ then, $\xmin S \ymin$.
\end{itemize}
