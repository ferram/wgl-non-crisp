...
we often replace a   cluster $\clust{z}$ with a representative element $z$ (e.g.,
we write $\Rnof{S_{x,y}}$   instead of
$\Rnof{S_{\clust{x},\clust{y}}}$).
...
\Rnof{S_{\Phi(w),\Phi(w')} } \to \Rnof{\Phi(w'),\a}\;=\;
    q_1    
  \]
Since $\Rnof{S_{\Phi(w),y}}\to  \Rnof{y,\a}\in \Qcal_2$,
we get $q_1\in\Qcal_2$;
...
\[
    \Rnof{S_{\Phi(w),\Phi(w')} } \to \Rnof{\Phi(w'),\a}  \;=\;
        \Rnof{S_{\Phi(w),y}}\to  \Rnof{y,\a} \;=\; q_2
\]
Since  $\Rnof{S_{\Phi(w),\Phi(w')} } \to \Rnof{\Phi(w'),\a}\in \Qcal_1$,
we get $q_2\in\Qcal_1$.
This proves $\Qcal_2\subseteq \Qcal_1$.
