...
Since $e(x,\varphi) = 0.6$, by Prop.~\ref{prop:Phi}
...
$\xmax S z$ and $z\nforcing \a$. Since $\xmax\forcing\Box\psi$, it follows that $z\forcing \psi$.
...
We conclude that $\varphi\in\GWL$.
\EndEx
\end{example}
...
\begin{lemma}\label{lemma:crispModel}
  Let $\K=\stru{X,\leq,S,V}$ be a crisp regular $\GWL$-bimodel and let  $x$.
...
\begin{example}\label{ex:crispModel}
  ...
  the Crisp axiom $\psi=\Box (\a\lor \b)\to (\Box \a \lor \Diam \b)$. Note that such a model is not crisp,
  since $x_{0.6} S y_{0.6}$, but it is not true that  $x_{1} S y_{1}$. We show that $\psi$ is valid in all crisp
  regular $\GWL$-bimodels. Let us assume, by contradiction, that there exists a  regular $\GWL$-bimodel
  $\K=\stru{X,\leq,S,V}$ and $x_0\in W$ such that $x_0\nforcing \psi$. 
  Then, there exists $x_1$ such hat $x_0\leq x_1$ and $x_1\forcing \Box (\a\lor \b)$ and  $x_1\nforcing \Box \a \lor \Diam \b$,
  thus   $x_1\nforcing \Box \a$ and  $x_1\nforcing  \Diam \b$.
  ...
  we get $y_1\forcing \a\lor \b$, and this implies $y_1\forcing \b$.
It follows that   $x_1\forcing  \Diam \b$, a contradiction.
We conclude that the Crisp axiom is valid in all crisp  regular $\GWL$-bimodels.
\EndEx
\end{example}
...
Let $\varphi=\neg \Diam \a\lor \neg\neg\Diam \a$.   We exploit Prop.~\ref{prop:equivGWC} to show that $\varphi\in\GWCL$.
Let us assume, by contradiction,   $\varphi\not\in\GWCL$.
By  Prop.~\ref{prop:equivGWC}, there exists a crisp regular  $\GWM$-bimodel $\K=\stru{X,\leq,S,V}$
and $x_0\in X$ such that:

\begin{itemize}
\item $x_0\nforcing\neg \Diam \a$ and  $x_0\nforcing\neg\neg\Diam \a$.
\end{itemize}
There exists $x_1\in X$ such that $x_0\leq x_1$ and $x_1\forcing  \Diam \a$;
...
Since $y_1\forcing \a$, there is no $y\in X$ such that $y_0\leq y$ and $y\forcing \neg \a$,
hence $y_0\forcing\neg\neg \a$. It follows that  $x_0\nforcing\neg\neg\Diam \a$, a contradiction.
We conclude that   $\varphi\in\GWCL$.
\EndEx  
  \end{example}
...
Let $\varphi$ be the axiom 
  ...
  \]
introduced in~\cite{VidalR:26}.
  We exploit Prop.~\ref{prop:equivGWC} to show that $\varphi\in\GWCL$.
Let us assume, by contradiction,   $\varphi\not\in\GWCL$.
By  Prop.~\ref{prop:equivGWC}, there exists a crisp regular  $\GWM$-bimodel $\K=\stru{X,\leq,S,V}$
and $x_0\in X$ such that:
\begin{itemize}
\item $x_0\forcing\Diam\a\to\Diam\b$ and $x_0\forcing (\Diam\b\to\Diam\g)\to\Diam\g$
  and $x_0\nforcing  \Diam\g$ and  $x_0\nforcing  \Diam\psi$. 
\end{itemize}
We get $x_0\nforcing \Diam\b\to\Diam\g$, hence there exists $x'\in X$
such that $x_0\leq x'$ and $x'\forcing \Diam\b$ and $x'\nforcing\Diam \g$.
Once can easily check that $x_0\nforcing\Diam \b$, hence 
 there exists $x_1\in X$ such that:
\begin{itemize}
\item $x_0 < x_1$ and  $x_1\forcing \Diam\b$ and $(x_1)^-\nforcing \Diam \b$.
\end{itemize}
Since  $x_1\forcing \Diam\b$, there exists $y_1\in X$ such that $x_1 S y_1$ and $y_1\forcing\b$. 
Since $\K$ is Crisp, there are $y_0$ and $y'$ in $X$ such that:
\begin{itemize}
\item $x_0 S y_0$ and $(x_1)^- S y'$.
\end{itemize}
By properties of Crisp models we get:
\begin{enumerate}[label=(\alph*), ref=(\alph*),leftmargin=*]
\item\label{ex:axiomGWC:1}
  $y_0\leq y'< y_1$ and $y'=(y_1)^-$.  
\end{enumerate}
Note that   $(x_1)^-\nforcing \Diam \a$, hence $y'\nforcing \a$ and  $y'\nforcing \b$.
By~\ref{ex:axiomGWC:1}, we get $y_0\forcing \psi$, hence $x_0\forcing \Diam \psi$, a contradiction.
We conclude $\varphi\in\GWCL$. \EndEx
 \end{example} 
