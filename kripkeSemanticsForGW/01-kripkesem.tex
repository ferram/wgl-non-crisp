...
order relation (intuitionistic accessibility relation), $S\subseteq X \times X$ (modal accesibility relation),
...
we often replace a   cluster $\clust{z}$ with a representative elemente $z$ (e.g.,
