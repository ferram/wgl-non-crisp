...
$(x_2)^- S y$ and $y\nforcing \a$. Note that $x_1\leq (x_2)^-$, hence $y\nforcing \psi$.
...
Note that $y <  y'$, hence   $(x_2)^-< x'$, which implies  $x_2\leq x'$.
Since $x_2\forcing \Box\a$ and  $x_2\forcing \Box\a\to \Box\b$, we get $x'\forcing\Box \b$.
